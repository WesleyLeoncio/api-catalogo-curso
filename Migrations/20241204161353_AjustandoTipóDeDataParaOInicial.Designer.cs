...
namespace api_catalogo_curso.Migrations
{
    ...
    [Migration("20241204161353_AjustandoTipóDeDataParaOInicial")]
    partial class AjustandoTipóDeDataParaOInicial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api_catalogo_curso.modules.user.models.entity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("api_catalogo_curso.modules.user.models.entity.ApplicationUser", null)
                        .WithMany()
